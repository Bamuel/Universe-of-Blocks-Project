...
<html>
<head>
    <title>Universe of Blocks #4</title>
...
<center>
    ...
    <div id="gamepanel1" style="position: relative; z-index: 2;" class="gamepanel1">
        <div id="EjCambioEstilo" class="block13" onclick="window.open('3.php')"></div>
        <div id="block10" class="10" onclick="getblockidf('block12');" onclick="window.open('3.php')"></div>
        ...
        <div id="1EjCambioEstilo42" class="block4" onclick="changeblock1('1EjCambioEstilo42')"></div>
        ...
        <div id="1EjCambioEstilo49" class="block4" onclick="changeblock1('1EjCambioEstilo49')"></div>
        ...
        <div id="2EjCambioEstilo41" class="block4" onclick="changeblock1('2EjCambioEstilo41')"></div>
        <div id="2EjCambioEstilo42" class="block4" onclick="changeblock1('2EjCambioEstilo42')"></div>
        <div id="2EjCambioEstilo43" class="block4" onclick="changeblock1('2EjCambioEstilo43')"></div>
        ...
        <div id="2EjCambioEstilo48" class="block4" onclick="changeblock1('2EjCambioEstilo48')"></div>
        <div id="2EjCambioEstilo49" class="block4" onclick="changeblock1('2EjCambioEstilo49')"></div>
        <div id="2EjCambioEstilo50" class="block4" onclick="changeblock1('2EjCambioEstilo50')"></div>
        ...
        <div id="3EjCambioEstilo11" class="block4" onclick="changeblock1('3EjCambioEstilo11')"></div>
        <div id="3EjCambioEstilo12" class="block4" onclick="changeblock1('3EjCambioEstilo12')"></div>
        <div id="3EjCambioEstilo13" class="block4" onclick="changeblock1('3EjCambioEstilo13')"></div>
        ...
        <div id="3EjCambioEstilo17" class="block4" onclick="changeblock1('3EjCambioEstilo17')"></div>
        <div id="3EjCambioEstilo18" class="block4" onclick="changeblock1('3EjCambioEstilo18')"></div>
        <div id="3EjCambioEstilo19" class="block4" onclick="changeblock1('3EjCambioEstilo19')"></div>
        <div id="3EjCambioEstilo20" class="block4" onclick="changeblock1('3EjCambioEstilo20')"></div>
        <div id="3EjCambioEstilo21" class="block4" onclick="changeblock1('3EjCambioEstilo21')"></div>
        ...
        <div id="3EjCambioEstilo24" class="block4" onclick="changeblock1('3EjCambioEstilo24')"></div>
        <div id="3EjCambioEstilo25" class="block4" onclick="changeblock1('3EjCambioEstilo25')"></div>
        <!--Line6-->
        ...
        <div id="3EjCambioEstilo41" class="block4" onclick="changeblock1('3EjCambioEstilo41')"></div>
        <div id="3EjCambioEstilo42" class="block4" onclick="changeblock1('3EjCambioEstilo42')"></div>
        <div id="3EjCambioEstilo43" class="block4" onclick="changeblock1('3EjCambioEstilo43')"></div>
        ...
        <div id="3EjCambioEstilo49" class="block6" onclick="changeblock1('3EjCambioEstilo49')"></div>
        ...
        <div id="3EjCambioEstilo53" class="block4" onclick="changeblock1('3EjCambioEstilo53')"></div>
        <div id="3EjCambioEstilo54" class="block4" onclick="changeblock1('3EjCambioEstilo54')"></div>
        <div id="3EjCambioEstilo55" class="block4" onclick="changeblock1('3EjCambioEstilo55')"></div>
        <!--Line7-->
        ...
        <div id="4EjCambioEstilo42" class="block6" onclick="changeblock1('4EjCambioEstilo42')"></div>
        ...
        <div id="4EjCambioEstilo49" class="block6" onclick="changeblock1('4EjCambioEstilo49')"></div>
        ...
        <div id="4EjCambioEstilo55" class="block6" onclick="changeblock1('4EjCambioEstilo55')"></div>
        <!--Line8-->
        ...
        <div id="44EjCambioEstilo33" class="block40" onclick="changeblock1('44EjCambioEstilo33')"></div>
        ...
        <div id="44EjCambioEstilo42" class="block6" onclick="changeblock1('44EjCambioEstilo42')"></div>
        ...
        <div id="44EjCambioEstilo48" class="block22" onclick="changeblock1('44EjCambioEstilo48')"></div>
        <div id="44EjCambioEstilo49" class="block6" onclick="changeblock1('44EjCambioEstilo49')"></div>
        ...
        <div id="44EjCambioEstilo55" class="block6" onclick="changeblock1('44EjCambioEstilo55')"></div>
        <!--Line9-->
        ...
        <div id="5EjCambioEstilo3" class="block40" onclick="changeblock1('5EjCambioEstilo3')"></div>
        ...
        <div id="5EjCambioEstilo11" class="block22" onclick="changeblock1('5EjCambioEstilo11')"></div>
        <div id="5EjCambioEstilo12" class="block6" onclick="changeblock1('5EjCambioEstilo12')"></div>
        <div id="5EjCambioEstilo13" class="block22" onclick="changeblock1('5EjCambioEstilo13')"></div>
        <div id="5EjCambioEstilo14" class="block0" onclick="changeblock1('5EjCambioEstilo14')"></div>
        <div id="5EjCambioEstilo15" class="block22" onclick="changeblock1('5EjCambioEstilo15')"></div>
        <div id="5EjCambioEstilo16" class="block0" onclick="changeblock1('5EjCambioEstilo16')"></div>
        <div id="5EjCambioEstilo17" class="block22" onclick="changeblock1('5EjCambioEstilo17')"></div>
        <div id="5EjCambioEstilo18" class="block2" onclick="changeblock1('5EjCambioEstilo18')"></div>
        <div id="5EjCambioEstilo19" class="block2" onclick="changeblock1('5EjCambioEstilo19')"></div>
        <div id="5EjCambioEstilo20" class="block0" onclick="changeblock1('5EjCambioEstilo20')"></div>
        <div id="5EjCambioEstilo21" class="block22" onclick="changeblock1('5EjCambioEstilo21')"></div>
        <div id="5EjCambioEstilo22" class="block22" onclick="changeblock1('5EjCambioEstilo22')"></div>
        <div id="5EjCambioEstilo23" class="block50" onclick="changeblock1('5EjCambioEstilo23')"></div>
        <div id="5EjCambioEstilo24" class="block50" onclick="changeblock1('5EjCambioEstilo24')"></div>
        <div id="5EjCambioEstilo25" class="block6" onclick="changeblock1('5EjCambioEstilo25')"></div>
        <!--Line10-->
        ...
        <div id="5EjCambioEstilo33" class="block40" onclick="changeblock1('5EjCambioEstilo33')"></div>
        ...
        <div id="5EjCambioEstilo39" class="block2" onclick="changeblock1('5EjCambioEstilo39')"></div>
        <div id="5EjCambioEstilo40" class="block2" onclick="changeblock1('5EjCambioEstilo40')"></div>
        <div id="5EjCambioEstilo41" class="block2" onclick="changeblock1('5EjCambioEstilo41')"></div>
        <div id="5EjCambioEstilo42" class="block2" onclick="changeblock1('5EjCambioEstilo42')"></div>
        <div id="5EjCambioEstilo43" class="block2" onclick="changeblock1('5EjCambioEstilo43')"></div>
        <div id="5EjCambioEstilo44" class="block2" onclick="changeblock1('5EjCambioEstilo44')"></div>
        <div id="5EjCambioEstilo45" class="block2" onclick="changeblock1('5EjCambioEstilo45')"></div>
        <div id="5EjCambioEstilo46" class="block2" onclick="changeblock1('5EjCambioEstilo46')"></div>
        <div id="5EjCambioEstilo47" class="block2" onclick="changeblock1('5EjCambioEstilo47')"></div>
        <div id="5EjCambioEstilo48" class="block7" onclick="changeblock1('5EjCambioEstilo48')"></div>
        <div id="5EjCambioEstilo49" class="block7" onclick="changeblock1('5EjCambioEstilo49')"></div>
        <div id="5EjCambioEstilo50" class="block2" onclick="changeblock1('5EjCambioEstilo50')"></div>
        <div id="5EjCambioEstilo51" class="block2" onclick="changeblock1('5EjCambioEstilo51')"></div>
        <div id="5EjCambioEstilo52" class="block2" onclick="changeblock1('5EjCambioEstilo52')"></div>
        <div id="5EjCambioEstilo53" class="block2" onclick="changeblock1('5EjCambioEstilo53')"></div>
        <div id="5EjCambioEstilo54" class="block2" onclick="changeblock1('5EjCambioEstilo54')"></div>
        <div id="5EjCambioEstilo55" class="block2" onclick="changeblock1('5EjCambioEstilo55')"></div>
        <!--Line11-->
        <div id="6EjCambioEstilo31" class="block11" onclick="changeblock1('6EjCambioEstilo31')"></div>
        <div id="6EjCambioEstilo32" class="block11" onclick="changeblock1('6EjCambioEstilo32')"></div>
        <div id="6EjCambioEstilo33" class="block11" onclick="changeblock1('6EjCambioEstilo33')"></div>
        <div id="6EjCambioEstilo34" class="block11" onclick="changeblock1('6EjCambioEstilo34')"></div>
        <div id="6EjCambioEstilo35" class="block11" onclick="changeblock1('6EjCambioEstilo35')"></div>
        <div id="6EjCambioEstilo36" class="block11" onclick="changeblock1('6EjCambioEstilo36')"></div>
        ...
        <div id="6EjCambioEstilo39" class="block7" onclick="changeblock1('6EjCambioEstilo39')"></div>
        <div id="6EjCambioEstilo40" class="block7" onclick="changeblock1('6EjCambioEstilo40')"></div>
        <div id="6EjCambioEstilo41" class="block7" onclick="changeblock1('6EjCambioEstilo41')"></div>
        <div id="6EjCambioEstilo42" class="block7" onclick="changeblock1('6EjCambioEstilo42')"></div>
        <div id="6EjCambioEstilo43" class="block7" onclick="changeblock1('6EjCambioEstilo43')"></div>
        <div id="6EjCambioEstilo44" class="block7" onclick="changeblock1('6EjCambioEstilo44')"></div>
        <div id="6EjCambioEstilo45" class="block7" onclick="changeblock1('6EjCambioEstilo45')"></div>
        <div id="6EjCambioEstilo46" class="block7" onclick="changeblock1('6EjCambioEstilo46')"></div>
        <div id="6EjCambioEstilo47" class="block7" onclick="changeblock1('6EjCambioEstilo47')"></div>
        <div id="6EjCambioEstilo48" class="block7" onclick="changeblock1('6EjCambioEstilo48')"></div>
        <div id="6EjCambioEstilo49" class="block7" onclick="changeblock1('6EjCambioEstilo49')"></div>
        <div id="6EjCambioEstilo50" class="block7" onclick="changeblock1('6EjCambioEstilo50')"></div>
        <div id="6EjCambioEstilo51" class="block7" onclick="changeblock1('6EjCambioEstilo51')"></div>
        <div id="6EjCambioEstilo52" class="block7" onclick="changeblock1('6EjCambioEstilo52')"></div>
        <div id="6EjCambioEstilo53" class="block7" onclick="changeblock1('6EjCambioEstilo53')"></div>
        <div id="6EjCambioEstilo54" class="block7" onclick="changeblock1('6EjCambioEstilo54')"></div>
        <div id="6EjCambioEstilo55" class="block7" onclick="changeblock1('6EjCambioEstilo55')"></div>
        <!--Line12-->
        <div id="7EjCambioEstilo" class="block11" onclick="changeblock1('7EjCambioEstilo')"></div>
        <div id="7EjCambioEstilo2" class="block11" onclick="changeblock1('7EjCambioEstilo2')"></div>
        <div id="7EjCambioEstilo3" class="block11" onclick="changeblock1('7EjCambioEstilo3')"></div>
        <div id="7EjCambioEstilo4" class="block11" onclick="changeblock1('7EjCambioEstilo4')"></div>
        <div id="7EjCambioEstilo5" class="block11" onclick="changeblock1('7EjCambioEstilo5')"></div>
