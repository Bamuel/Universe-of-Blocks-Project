...
<html>
<head>
    <title>Universe of Blocks #3</title>
...
<center>
    ...
    <div id="gamepanel1" style="position: relative; z-index: 2;" class="gamepanel1">
        <div id="EjCambioEstilo" class="block13" onclick="window.open('2.php')"></div>
        ...
        <div id="EjCambioEstilo25" class="block12" onclick="window.open('4.php')"></div>
        <!--Line2-->
        ...
        <div id="4EjCambioEstilo38" class="block40" onclick="changeblock1('4EjCambioEstilo38')"></div>
        ...
        <div id="4EjCambioEstilo44" class="block40" onclick="changeblock1('4EjCambioEstilo44')"></div>
        ...
        <div id="44EjCambioEstilo38" class="block40" onclick="changeblock1('44EjCambioEstilo38')"></div>
        ...
        <div id="44EjCambioEstilo44" class="block40" onclick="changeblock1('44EjCambioEstilo44')"></div>
        ...
        <div id="44EjCambioEstilo55" class="block40" onclick="changeblock1('44EjCambioEstilo55')"></div>
        <!--Line9-->
        ...
        <div id="5EjCambioEstilo6" class="block11" onclick="changeblock1('5EjCambioEstilo6')"></div>
        <div id="5EjCambioEstilo7" class="block0" onclick="changeblock1('5EjCambioEstilo7')"></div>
        <div id="5EjCambioEstilo8" class="block40" onclick="changeblock1('5EjCambioEstilo8')"></div>
        <div id="5EjCambioEstilo9" class="block0" onclick="changeblock1('5EjCambioEstilo9')"></div>
        <div id="5EjCambioEstilo10" class="block11" onclick="changeblock1('5EjCambioEstilo10')"></div>
        ...
        <div id="5EjCambioEstilo14" class="block40" onclick="changeblock1('5EjCambioEstilo14')"></div>
        ...
        <div id="5EjCambioEstilo25" class="block40" onclick="changeblock1('5EjCambioEstilo25')"></div>
        <!--Line10-->
        ...
        <div id="5EjCambioEstilo35" class="block11" onclick="changeblock1('5EjCambioEstilo35')"></div>
        <div id="5EjCambioEstilo36" class="block11" onclick="changeblock1('5EjCambioEstilo36')"></div>
        <div id="5EjCambioEstilo37" class="block11" onclick="changeblock1('5EjCambioEstilo37')"></div>
        <div id="5EjCambioEstilo38" class="block11" onclick="changeblock1('5EjCambioEstilo38')"></div>
        <div id="5EjCambioEstilo39" class="block11" onclick="changeblock1('5EjCambioEstilo39')"></div>
        <div id="5EjCambioEstilo40" class="block11" onclick="changeblock1('5EjCambioEstilo40')"></div>
        <div id="5EjCambioEstilo41" class="block11" onclick="changeblock1('5EjCambioEstilo41')"></div>
        <div id="5EjCambioEstilo42" class="block11" onclick="changeblock1('5EjCambioEstilo42')"></div>
        <div id="5EjCambioEstilo43" class="block11" onclick="changeblock1('5EjCambioEstilo43')"></div>
        <div id="5EjCambioEstilo44" class="block11" onclick="changeblock1('5EjCambioEstilo44')"></div>
        <div id="5EjCambioEstilo45" class="block11" onclick="changeblock1('5EjCambioEstilo45')"></div>
        <div id="5EjCambioEstilo46" class="block11" onclick="changeblock1('5EjCambioEstilo46')"></div>
        <div id="5EjCambioEstilo47" class="block11" onclick="changeblock1('5EjCambioEstilo47')"></div>
        ...
        <div id="6EjCambioEstilo35" class="block51" onclick="changeblock1('6EjCambioEstilo35')"></div>
        <div id="6EjCambioEstilo36" class="block51" onclick="changeblock1('6EjCambioEstilo36')"></div>
        <div id="6EjCambioEstilo37" class="block11" onclick="changeblock1('6EjCambioEstilo37')"></div>
        <div id="6EjCambioEstilo38" class="block11" onclick="changeblock1('6EjCambioEstilo38')"></div>
        <div id="6EjCambioEstilo39" class="block11" onclick="changeblock1('6EjCambioEstilo39')"></div>
        <div id="6EjCambioEstilo40" class="block11" onclick="changeblock1('6EjCambioEstilo40')"></div>
        <div id="6EjCambioEstilo41" class="block11" onclick="changeblock1('6EjCambioEstilo41')"></div>
        <div id="6EjCambioEstilo42" class="block11" onclick="changeblock1('6EjCambioEstilo42')"></div>
        <div id="6EjCambioEstilo43" class="block51" onclick="changeblock1('6EjCambioEstilo43')"></div>
        <div id="6EjCambioEstilo44" class="block51" onclick="changeblock1('6EjCambioEstilo44')"></div>
        <div id="6EjCambioEstilo45" class="block51" onclick="changeblock1('6EjCambioEstilo45')"></div>
        ...
        <div id="6EjCambioEstilo49" class="block20" onclick="changeblock1('6EjCambioEstilo49')"></div>
        <div id="6EjCambioEstilo50" class="block20" onclick="changeblock1('6EjCambioEstilo50')"></div>
        <div id="6EjCambioEstilo51" class="block20" onclick="changeblock1('6EjCambioEstilo51')"></div>
        <div id="6EjCambioEstilo52" class="block20" onclick="changeblock1('6EjCambioEstilo52')"></div>
        ...
        <!--Line12-->
        <div id="7EjCambioEstilo" class="block51" onclick="changeblock1('7EjCambioEstilo')"></div>
        <div id="7EjCambioEstilo2" class="block51" onclick="changeblock1('7EjCambioEstilo2')"></div>
        <div id="7EjCambioEstilo3" class="block51" onclick="changeblock1('7EjCambioEstilo3')"></div>
        <div id="7EjCambioEstilo4" class="block51" onclick="changeblock1('7EjCambioEstilo4')"></div>
        <div id="7EjCambioEstilo5" class="block51" onclick="changeblock1('7EjCambioEstilo5')"></div>
        <div id="7EjCambioEstilo6" class="block51" onclick="changeblock1('7EjCambioEstilo6')"></div>
        <div id="7EjCambioEstilo7" class="block51" onclick="changeblock1('7EjCambioEstilo7')"></div>
        <div id="7EjCambioEstilo8" class="block51" onclick="changeblock1('7EjCambioEstilo8')"></div>
        <div id="7EjCambioEstilo9" class="block51" onclick="changeblock1('7EjCambioEstilo9')"></div>
        <div id="7EjCambioEstilo10" class="block51" onclick="changeblock1('7EjCambioEstilo10')"></div>
        <div id="7EjCambioEstilo11" class="block51" onclick="changeblock1('7EjCambioEstilo11')"></div>
        <div id="7EjCambioEstilo12" class="block51" onclick="changeblock1('7EjCambioEstilo12')"></div>
        <div id="7EjCambioEstilo13" class="block51" onclick="changeblock1('7EjCambioEstilo13')"></div>
        <div id="7EjCambioEstilo14" class="block51" onclick="changeblock1('7EjCambioEstilo14')"></div>
        <div id="7EjCambioEstilo15" class="block51" onclick="changeblock1('7EjCambioEstilo15')"></div>
        <div id="7EjCambioEstilo16" class="block51" onclick="changeblock1('7EjCambioEstilo16')"></div>
        <div id="7EjCambioEstilo17" class="block51" onclick="changeblock1('7EjCambioEstilo17')"></div>
        <div id="7EjCambioEstilo18" class="block51" onclick="changeblock1('7EjCambioEstilo18')"></div>
        <div id="7EjCambioEstilo19" class="block3" onclick="changeblock1('7EjCambioEstilo19')"></div>
        <div id="7EjCambioEstilo20" class="block3" onclick="changeblock1('7EjCambioEstilo20')"></div>
        <div id="7EjCambioEstilo21" class="block3" onclick="changeblock1('7EjCambioEstilo21')"></div>
        <div id="7EjCambioEstilo22" class="block3" onclick="changeblock1('7EjCambioEstilo22')"></div>
        <div id="7EjCambioEstilo23" class="block51" onclick="changeblock1('7EjCambioEstilo23')"></div>
        <div id="7EjCambioEstilo24" class="block51" onclick="changeblock1('7EjCambioEstilo24')"></div>
        <div id="7EjCambioEstilo25" class="block51" onclick="changeblock1('7EjCambioEstilo25')"></div>
